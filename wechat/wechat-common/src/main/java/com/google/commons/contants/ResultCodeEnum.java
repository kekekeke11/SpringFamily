package com.google.commons.contants;
...
public enum  ResultCodeEnum {
    ...
    MAIL_SEND_FAILED(false, 41001, "邮件发送失败"),
    CAPTCHA_SEND_FAILED(false, 41002, "验证码发送失败"),
    CREATE_WXPAY_BEAN_FAIL(false,42001,"创建默认wxpay实列失败");
